...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
messages: [
  "Chúc em 20/10 thật nhiều niềm vui và hạnh phúc 💐",
  "Cảm ơn em vì đã luôn bên anh và yêu thương anh 💖",
  "Em luôn là cô gái tuyệt vời và đặc biệt nhất trong tim anh 🌸",
  "Chúc em mãi xinh đẹp, rạng rỡ và được yêu thương 💞",
  "Anh chúc em ngày 20/10 thật ngọt ngào và tràn đầy yêu thương ❤️"
],
...
function generateTextRingTexture(t) {
  ...
  a["font"] = 'bold 100px "Mali", sans-serif';
  a.textAlign = "center";
  a.textBaseline = "middle";
